...
ops.fbinary             = fullfile(basepath,[basename '.dat']); % will be created for 'openEphys'		
ops.fproc               = fullfile(basepath,'temp_wh.dat'); % residual from RAM of preprocessed data		
ops.root                = basepath; % 'openEphys' only: where raw files are		
...
ops.chanMap             = fullfile(basepath,'chanMap.mat'); % make this file using createChannelMapFile.m		
