...
ops.Nfilt              =   xml.nChannels*7 - mod(xml.nChannels*7,32);           % number of filters to use (2-4 times more than Nchan, should be a multiple of 32)
if ops.Nfilt > 1024;
    ops.Nfilt = 1024;
elseif ops.Nfilt == 0
    ops.Nfilt = 32;
...
ops.fslow             = 7000;   % frequency for low pass filtering (optional)
...
ops.lam              = [8 20 20];   % large means amplitudes are forced around the mean ([10 30 30])
